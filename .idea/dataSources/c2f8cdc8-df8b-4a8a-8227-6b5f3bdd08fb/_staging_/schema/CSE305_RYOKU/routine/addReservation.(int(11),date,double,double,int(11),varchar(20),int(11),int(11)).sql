CREATE PROCEDURE addReservation(IN cust_id INT, IN date DATE, IN fare DOUBLE, IN book_fee DOUBLE, IN employee_id INT,
                                IN rest    VARCHAR(20), IN length_stay INT, IN advPurchase INT , IN numberofPassengers INT)
  BEGIN
