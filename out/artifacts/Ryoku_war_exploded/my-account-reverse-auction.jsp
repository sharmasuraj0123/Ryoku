...
<div class="uk-container">
    <h3 class="uk-heading-line uk-text-left"> <span>My Reverse Auctions</span></h3>
        ...
        <div class="uk-width-expand">
            <div class="uk-card uk-card-default uk-card-small uk-card-body">
                <div class="uk-margin">
                    ...
                    <ul uk-accordion>
                        <li>
                            <h3 class="uk-accordion-title small-font"> Reverse Auction </h3>
                            <div class="uk-accordion-content">
                                <div class="uk-margin-small uk-grid-small" uk-grid>
                                    <div class="uk-width-1-3 uk-text-small">
                                        Past Bid #1
                                    </div>
                                    <div class="uk-width-1-3 uk-text-left uk-text-small">
                                        My Price: &nbsp; <span> $700<sup>.00</sup> </span>
                                    </div>
                                    ...
                                    <div class="uk-width-1-3 uk-text-left uk-text-small">
                                        My Price: <input type="text" class="uk-input uk-form-width-small uk-form-blank uk-form-small" placeholder="$">
                                    </div>
                                    <div class="uk-width-1-3 uk-text-small uk-text-right">
